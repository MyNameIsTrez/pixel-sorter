...
bool should_swap(
	...
	float4 i1_averaged = get_averaged_score_pixel(pixels, neighbor_totals, width, height, pos1);
	...
	float4 i2_averaged = get_averaged_score_pixel(pixels, neighbor_totals, width, height, pos2);
